...
public partial class _Default : System.Web.UI.Page
{
    ...
    */
    ...
    protected void GridView1_RowCommand(object sender,GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "yan")
        {
            ...
            string pass_message = "Device:" + productName_Device.Text + "<br>" + "Production_Site:" + productName_Production_Site.Text + "<br>"
                                + "PKG:" + productName_PKG.Text + "<br>" + "Wafer Tech.(nm) :" + productName_Wafer.Text + "<br>" + "FAB:" + productName_fab.Text
            ...
            //strScript = "<script language='javascript'>Confirm("+pass_message+"'確定要將八個條件帶入到EP_TRA報表中嗎？','" + arydata + "');</script>";
    ...
    {
        string temp = Session["value_sign1"].ToString();
